...
class Agendamento : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.timePicker.setIs24HourView(true) //formato 24hrs
        ...
        binding.btAgendar.setOnClickListener{
            ...
            when{
                ...
                hora < "8:00" && hora > "19:00" ->{
                    mensagem(it, "Horário de atendimento: 08:00 às 19:00!", "#FF0000")
                ...
                barbeiro2.isChecked && data.isNotEmpty() && hora.isNotEmpty() ->{
                    salvarAgendamento(it, nome, "Wellington Tavares", data, hora)

                }
                barbeiro3.isChecked && data.isNotEmpty() && hora.isNotEmpty() ->{
                    salvarAgendamento(it, nome, "Manuel Gomes", data, hora)
